...
\fill[MenSlateLight, rounded corners=2pt, draw=MenSlate!18, line width=0.5pt]
  (0.05,-0.02) rectangle (11.0,0.28);
\node[font=\tiny, text width=10.8cm, align=center] at (5.52,0.13) {%
  \textbf{Workshop lens:} safety requires context, intent, and preference---not
  only collision-free motion. The harmful act is often the \textbf{first
  irreversible commitment}.%
};
\end{tikzpicture}%
}
\caption{Initiation authorization: passive thresholds vs.\ probe--authorize--speak.
Collision-free motion does not imply safe initiation.}
\label{fig:teaser}
\end{figure*}
